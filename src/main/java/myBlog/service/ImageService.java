...
public class ImageService {
  ...
  public String saveImage(MultipartFile image, HttpServletRequest request ) throws IOException {
    ...
    if (contentType.equals("jpeg") || contentType.equals("png")) {
      ...
      FileUtils.writeByteArrayToFile(new File(realPath), image.getBytes());
